...
from bisheng.api.v1 import (assistant_router, audit_router, chat_router, component_router,
                            ...
                            user_router, validate_router, variable_router, workflow_router,kb_app_router,document_app_router,chunk_rag_router,llm_app_router)
...
router.include_router(llm_app_router)
router.include_router(chunk_rag_router)
router.include_router(document_app_router)
router.include_router(kb_app_router)
