...
from bisheng.api.util import current_timestamp, get_format_time, get_uuid
...
from bisheng.api.db.db_models import Document
...
class DocumentService(CommonService):
    ...
    def accessible(cls, doc_id, user_id):
        ...
        ).where(cls.model.id == doc_id, Knowledgebase.tenant_id == user_id).paginate(0, 1)
        docs = docs.dicts()
        if not docs:
            return False
        return True
